...
class TestOptimizedExtractor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch('xtract.core.extractor.load_config') as mock_load_config:
            ...
            with patch('xtract.core.extractor.EntityFactory') as mock_entity_factory, \
    ...
    def test_token_normalization(self):
        ...
        self.assertEqual(self.extractor._normalize_token("classes"), "classe")  # Not 'class' to avoid keyword
    ...
    def test_token_based_match_sliding_window(self):
        ...
        source_tokens = ["this", "document", "is", "a", "purchase", "agreement", "between", "parties"]
...
class TestPerformanceImprovements(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch('xtract.core.extractor.load_config') as mock_load_config:
            ...
            with patch('xtract.core.extractor.EntityFactory'), \
